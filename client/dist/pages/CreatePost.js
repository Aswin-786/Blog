...
const CreatePost = () => {
    ...
    function createNewPost(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield axios_1.default.post("http://localhost:4000/post", data, {
    ...
    return (react_1.default.createElement("form", { onSubmit: createNewPost, className: "flex flex-col gap-5 mt-32" },
        ...
        react_1.default.createElement("button", { className: "mt-2" }, " Create Post")));
};
